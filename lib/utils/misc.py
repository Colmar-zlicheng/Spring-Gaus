...
bar_perfixes = {
    "static": colored("Static", "yellow", attrs=["bold"]),
    "regist": colored("Regist", "yellow", attrs=["bold"]),
    "velocity": colored("Velocity", "yellow", attrs=["bold"]),
    "dynamic": colored("Dynamic", "yellow", attrs=["bold"]),
